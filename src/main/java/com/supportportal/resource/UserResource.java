...
public class UserResource extends ExceptionHandling {
    public static final String EMAIL_SENT = "New password was sent to: ";
    ...
    public ResponseEntity<User> addNewUser(@RequestParam("firstName") String firstName,
                                           ...
                                           @RequestParam(value = "profileImage", required = false) MultipartFile profileImage) throws UserNotFoundException, UsernameExistException, EmailExistException, IOException, MessagingException {
